...
var parseResult = function (result, params) {
	...
	var startIndex = parseInt(params.page) * parseInt(params.perPage);
	var endIndex = parseInt(startIndex) + parseInt(params.perPage);

	// Get part of Array and slice in new Array
	var subObj = resultObj;
	// var subObj = resultObj.slice(startIndex, endIndex);
